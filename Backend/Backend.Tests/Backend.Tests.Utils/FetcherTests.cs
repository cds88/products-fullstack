...
namespace Backend.Tests.Utils.Http
{
    public class FetcherTests
    {
        ...
        // {
        //     // Arrange: mock two pages of products
        ...
        //     // Assert
        //     Assert.NotNull(result);
        //     Assert.Equal(4, result.Count);  // 2 products from each page
        //     Assert.Equal("Product 1", result[0].Title);
        ...
        // {
        //     // Arrange: mock an invalid response (e.g., missing required fields)
        //     _httpMessageHandlerMock
        //         .Protected()
        ...
        //     // Act & Assert
        //     await Assert.ThrowsAsync<InvalidOperationException>(() => _fetcher.FetchData(0));
        // }
        // [Fact]
        // public async Task FetchData_ShouldThrowException_WhenInvalidResponse()
        // {
        //     // Arrange: mock an invalid response (e.g., malformed response)
        //     _httpMessageHandlerMock
        //         .Protected()
        //         .Setup<Task<HttpResponseMessage>>("SendAsync", ItExpr.IsAny<HttpRequestMessage>(), ItExpr.IsAny<System.Threading.CancellationToken>())
        //         .ReturnsAsync(new HttpResponseMessage
